#if !defined(RC_NO_THREADS) && !defined(_WIN32) && !defined(GEKKO) && !defined(__3DS__) && !defined(_3DS) && !defined(VITA) && !defined(WIIU) && !defined(__SWITCH__) && !defined(__APPLE__) && (!defined(_XOPEN_SOURCE) || (_XOPEN_SOURCE - 0) < 500)
